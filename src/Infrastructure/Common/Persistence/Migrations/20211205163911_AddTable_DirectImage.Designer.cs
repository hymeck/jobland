...
namespace Jobland.Infrastructure.Common.Persistence.Migrations
{
    ...
    [Migration("20211205163911_AddTable_DirectImage")]
    partial class AddTable_DirectImage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobland.Infrastructure.Common.Messenger.DirectMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasComment("direct messages from one user to other user");
            ...
            modelBuilder.Entity("Jobland.Infrastructure.Common.Messenger.DirectMessage", b =>
                {
                    b.HasOne("Jobland.Infrastructure.Common.Identity.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Jobland.Infrastructure.Common.Identity.User", "Sender")
                        .WithMany()
